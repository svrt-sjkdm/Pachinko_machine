...
void CFiguras::prisma2 (GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
				...
				{-0.5 ,-0.5, 0.5},    //Coordenadas Vértice 1 V17 
...
void CFiguras::prismaEntorno(GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6) {
	GLfloat vertice[8][3] = {
		{ 0.5 ,-0.5, 0.5 },    //Coordenadas Vértice 0 V0
		{ -0.5 ,-0.5, 0.5 },    //Coordenadas Vértice 1 V1
		{ -0.5 ,-0.5, -0.5 },    //Coordenadas Vértice 2 V2
	...
	glBindTexture(GL_TEXTURE_2D, text4);  // *** CORRECTA ***
	glBegin(GL_POLYGON);	//Right
							//glColor3f(0.0,0.0,1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[0]);
	...
	glBindTexture(GL_TEXTURE_2D, text1);  // *** TEXTURA CORRECTA ***
	glBegin(GL_POLYGON);	//Back
							//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[6]);
